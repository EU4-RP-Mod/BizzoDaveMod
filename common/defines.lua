...
NDiplomacy = {
	...
	PEACE_COST_PILLAGE_CAPITAL = 0,					-- Pillage a capital state's dev (scales by province wealth)
	...
	MONTHS_BEFORE_TOTAL_OCCUPATION = 0,			-- Before this many months have passed in the war, you cannot gain 100% warscore by just occupying the warleader
...
NCountry = {
	...
	DISINHERIT_PRESTIGE_THRESHOLD = -75,
	...
	ESTATE_MIN_DISTRIBUTED_CROWNLAND = 31, 	-- Minimum of crownland when distributing land at start
	...
	CONCENTRATED_DEV_LIBERTY_DESIRE_PER_DEV = 0,
	...
	CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0.0,
	PILLAGE_CAPITAL_DEVELOPMENT_DECREASE = 0.0,
	...
	PILLAGE_CAPITAL_MAX_DEV_PILLAGED = 0,
...
NMilitary = {
	...
	LEADER_MAINTENANCE_COST = 0,					-- how much mil power each leader costs.
...
NAI = {
	...
	PEACE_TERMS_PILLAGE_CAPITAL_MULT = 0.0,
	...
	ESTATE_MAX_PRIVILEDGES = 3,
	MIN_SCORE_TO_CONCENTRATE_DEVELOPMENT = 0,
},
...
NGovernment = {
	...
	DICTATORSHIP_TO_MONARCHY_REFORM_PENALTY = 1,
	NATIVE_REFORM_REFORM_PENALTY = 1,
	...
	CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0.0,
	CONCENTRATE_DEVELOPMENT_OTHER_STATE_PROVINCES_PROPORTION = 0.0,
	FREE_CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0.0,
	FREE_CONCENTRATE_DEVELOPMENT_OTHER_STATE_PROVINCES_PROPORTION = 0.0,
},
